...
namespace LeetCode.Com.Test
{
    public class EasyTest
    {
        public static void Start()
        {
            ...
            //Console.WriteLine(no0101.IsSymmetric(treenode0101_1));
            //Console.WriteLine(no0101.IsSymmetric(treenode0101_2));
            //Console.WriteLine(no0101.IsSymmetric(treenode0101_3));
            #endregion
            ...
            //TreeNode treenode0107_1 = Utils.CreateTreeNode(new List<int>() { 1, 2, 2, 3, 4, 4, 3 });
            //TreeNode treenode0107_2 = Utils.CreateTreeNode(new List<int>() { 1, 2, 2, 3, 4, 4, 3, 5, 6, 7, 8, 8, 7, 6, 5 });
            //TreeNode treenode0107_3 = Utils.CreateTreeNode(new List<string>() { "3", "9", "20", "null", "null", "15", "7" });
            ...
            #region No0122
            //No0122 no0122 = new No0122();
            //Console.WriteLine(no0122.MaxProfit(new int[] { 7, 1, 5, 3, 6, 4 }));
            //Console.WriteLine(no0122.MaxProfit(new int[] { 1, 2, 3, 4, 5 }));
            //Console.WriteLine(no0122.MaxProfit(new int[] { 7, 6, 4, 3, 1 }));
            #endregion
            ...
            #region No0922
            //No0922 no0922 = new No0922();
            //{
            //    Console.WriteLine(no0922.SortArrayByParityII(new int[] { 4, 2, 5, 7 }).ToConsoleString()); // [4,7,2,5], [2,5,4,7], [2,7,4,5]
            //    Console.WriteLine(no0922.SortArrayByParityII(new int[] {2,3 }).ToConsoleString());   //2,3
            //}
            #endregion
            ...
            //{
            //    Console.WriteLine(no1365.SmallerNumbersThanCurrent(new int[] { 8, 1, 2, 2, 3 }).ToConsoleString());    //[4,0,1,1,3]
            //    Console.WriteLine(no1365.SmallerNumbersThanCurrent(new int[] { 6, 5, 4, 8 }).ToConsoleString());       //[2,1,0,3]
            //    Console.WriteLine(no1365.SmallerNumbersThanCurrent(new int[] { 7, 7, 7, 7 }).ToConsoleString());       //[0,0,0,0]
            //}
            #endregion
